...
do
  local mode_labels_map = setmetatable({
    normal = { name = "normal", color = palette.bright_orange, bold = true },
    insert = { name = "insert", color = palette.bright_blue, bold = true },
    visual = { name = "visual", color = palette.bright_yellow, bold = true },
    visual_lines = { name = "visual", color = palette.bright_yellow, bold = true },
    visual_block = { name = "visual", color = palette.bright_yellow, bold = true },
    select = { name = "select", color = palette.bright_blue, bold = true },
    replace = { name = "replace", color = palette.bright_red, bold = true },
    command = { name = "command", color = palette.bright_green, bold = true },
    terminal = { name = "terminal", color = palette.bright_aqua, bold = true },
    op = { name = "op", color = palette.bright_purple, bold = true },
    none = { name = "none", color = palette.bright_purple, bold = true },
  }, {
